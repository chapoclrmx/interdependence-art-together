...
const userGroups: ConnectedUser[][] = [
  ...
  [
    { id: "4", name: "Lucas R.", x: 30, y: 52, country: "Brazil" },
    { id: "5", name: "Yuki T.", x: 82, y: 32, country: "Japan" },
    { id: "6", name: "Emma W.", x: 48, y: 24, country: "UK" },
  ],
  // Group 3 - India, Canada, South Africa
  [
    { id: "7", name: "Priya K.", x: 66, y: 38, country: "India" },
    { id: "8", name: "Marc D.", x: 18, y: 24, country: "Canada" },
    { id: "9", name: "Thabo M.", x: 52, y: 55, country: "South Africa" },
  ],
];
